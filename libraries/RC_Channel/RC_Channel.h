...
public:
    ...
    */
    ...
    void       clear_override();
    void       set_override(const uint16_t v, const uint16_t source, const uint32_t timestamp_us);
...
public:
    ...
    static void set_override(const uint8_t chan, const int16_t value, const uint16_t source, const uint32_t timestamp_ms); // set a channels override value
