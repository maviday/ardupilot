...
void Plane::update_soaring() {
    ...
    case Mode::Number::LOITER: {
        ...
        if (!ahrs.get_relative_position_NED_home(position)) {
            ...
            set_mode(mode_rtl, MODE_REASON_SOARING_DRIFT_EXCEEDED);
        }
        ...
        case Mode::Number::FLY_BY_WIRE_B: {
            ...
            switch (loiterStatus) {
                ...
                case SoaringController::LoiterStatus::DRIFT_EXCEEDED:
                    ...
                    set_mode(mode_fbwb, MODE_REASON_SOARING_DRIFT_EXCEEDED);
                    break;
                } // switch louterStatus
            break;
            }
        ...
        case Mode::Number::CRUISE: {
            ...
            switch (loiterStatus) {
                ...
                case SoaringController::LoiterStatus::DRIFT_EXCEEDED:
                    ...
                    set_mode(mode_cruise, MODE_REASON_SOARING_DRIFT_EXCEEDED);
                    break;
            } // switch loiterStatus
            cruise_state = cruise;
        ...
        case Mode::Number::AUTO: {
            ...
            switch (loiterStatus) {
                ...
                case SoaringController::LoiterStatus::DRIFT_EXCEEDED:
                    ...
                    set_mode(mode_auto, MODE_REASON_SOARING_DRIFT_EXCEEDED);
                    break;
                } // switch loiterStatus
            break;
            } // case AUTO
