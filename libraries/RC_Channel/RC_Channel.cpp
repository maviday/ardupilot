...
void RC_Channel::set_override(const uint16_t v, const uint16_t source, const uint32_t timestamp_us)
{
    ...
    //gcs().send_text(MAV_SEVERITY_INFO, "%d Source: %d, value: %d ", timestamp_us, source, v);
